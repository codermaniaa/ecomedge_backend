...
EcomEdge Server Documentation


Introduction: 

This is ready api backend for EcomEdge admin and frontend built with node.js, express, mongoose, and mongodb for database. 
...
For getting started with the template you have to follow the below procedure. First navigate to the EcomEdge-server directory.
